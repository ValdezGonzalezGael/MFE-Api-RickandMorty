...
NOTA.- Recuerda cambiar la IP por la de tu equipo; de momento la mía es "10.88.49.106", en todo caso puedes acceder.

*Guía de test con Jest--------------------------------------------------------------------------------------------
1.- Para observar los test, coloca en cada terminal de cada microfrontend
#npm run test